...
<div class="min-h-[80vh] flex items-center justify-center px-4">
	<div class="w-full max-w-sm animate-fade-up">
		...
		<div class="relative my-6">
			...
			<div class="relative flex justify-center text-xs uppercase tracking-[0.1em]">
				<span class="bg-sand-50 px-3 text-volcanic-300">or</span>
			</div>
		</div>

		<button
			onclick={() => authClient.signIn.social({ provider: 'google', callbackURL: '/' })}
			class="w-full flex items-center justify-center gap-3 bg-white border border-sand-200 text-volcanic-700 py-3 px-4 rounded-full hover:bg-sand-50 transition-all font-medium shadow-warm hover:shadow-warm-lg"
		>
